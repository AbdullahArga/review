...
<body class="antialiased">
        ...
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            <div class="flex lg:flex-1">
                <a href="#" class="-m-1.5 p-1.5">
                    ...
                    <img class=" w-auto" src="/images/logo.svg" alt="">
                </a>
            </div>
                                ...
                                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                                    @auth
                                        <a href="{{ url('/dashboard') }}"
                                            class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Dashboard<span
        ...
        <div class="lg:hidden" role="dialog" aria-modal="true">
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <a href="#" class="-m-1.5 p-1.5">
                        <span class="sr-only">Your Company</span>
                        <img class="h-8 w-auto" src="/images/hero.png" alt="">
                    </a>
    ...
    {{-- hero --}}
    <section class="bg-white dark:bg-gray-900 pl-5 pr-5">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div class="mr-auto place-self-center lg:col-span-7">
                <h1
                    class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
                    Welcome to Our Websit</h1>
                <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                    Here, you can find the latest notes published by our management. Stay updated and informed!</p>
                <a href="#"
            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img src="/images/hero.svg" alt="mockup">
            </div>
        </div>
    </section>
    {{-- main section --}}
    <section class="bg-white dark:bg-gray-900 pl-5 pr-5">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="max-w-screen-md mb-8 lg:mb-16">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Latest News</h2>
                <p class="text-gray-500 sm:text-xl dark:text-gray-400">Stay updated with the latest news and
                    announcements from our management.</p>
            </div>
                ...
                @foreach ($notes as $note)
                    <div>
                        <div
                            ...
                            <img src="/images/note-logo.png" alt="mockup">
                        </div>
                        <h3 class="mb-2 text-xl font-bold dark:text-white">{{ $note->title }}</h3>
                        <p class="text-gray-500 dark:text-gray-400">
                            {{ Str::limit($note->body, $limit = 500, $end = '...') }}</p>
                    </div>
                @endforeach
            </div>
            </hr>
